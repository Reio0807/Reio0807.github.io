...
between my multi-agent LLM work and the safety literature: the same systems I build to *simulate*
economies are instances of the risk surface this paper maps.
